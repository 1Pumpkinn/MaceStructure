            ...
            registrar.register(
                Commands.literal("macetp")
                    ...
                    .executes(ctx -> {
                        ...
                        ctx.getSource().getSender().sendMessage("Mace structure at " + world.getName() + " (" + x + ", " + y + ", " + z + ")");
            ...
            registrar.register(
                Commands.literal("macegen")
                    ...
                    .executes(ctx -> {
                        ...
                        ctx.getSource().getSender().sendMessage("Generation attempt complete. Check console for details.");
                        return Command.SINGLE_SUCCESS;
                    })
                    .then(Commands.literal("force").executes(ctx -> {
                        ...
                        ctx.getSource().getSender().sendMessage("Forced generation attempt complete. Check console for details.");
                        return Command.SINGLE_SUCCESS;
                    }))
                    .build(),
